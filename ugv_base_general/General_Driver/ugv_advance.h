...
void baseInfoFeedback() {
	...
	jsonInfoHttp["odom"]["L"] = speedGetA;
	jsonInfoHttp["odom"]["R"] = speedGetB;

	jsonInfoHttp["imu"]["r"] = icm_roll;
	jsonInfoHttp["imu"]["p"] = icm_pitch;
	jsonInfoHttp["imu"]["y"] = icm_yaw;
	// jsonInfoHttp["y"] = "null";
	...
	jsonInfoHttp["bat"]["v"] = loadVoltage_V;
	jsonInfoHttp["bat"]["ma"] = current_mA;
