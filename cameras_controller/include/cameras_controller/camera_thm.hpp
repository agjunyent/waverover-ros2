...
class CameraTHM final : public Camera
{
public:
    CameraTHM(const rclcpp::Node::SharedPtr& node, const std::string& port_or_ip, const int fps, const std::array<int, 3> resolution);
    ~CameraTHM();
